...
function loadNextBatch() {
  ...
  batch.forEach((wallpaper) => {
    ...
    img.src = "../assets/images/mobile/" + wallpaper;
    img.alt = "Wallpaper";
    img.loading = "lazy";
    img.className = "previewable fade-in";
    img.addEventListener('click', () => {
      modalImage.src = "../assets/images/mobile/" + wallpaper;
      downloadBtn.href = "../assets/images/mobile/" + wallpaper;
...
fetch('../json/mobile-wallpapers.json')
